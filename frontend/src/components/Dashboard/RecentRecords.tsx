          ...
          <div className="recent-panel">
            ...
            <div className="recent-list">
              {recentTrades.slice(0, 5).map((trade) => {
                ...
                const isLiquidated = trade.isLiquidated || trade.positionQuantity <= 0;
                const isHolding = !isLiquidated && !isBuy && !isSell && trade.positionQuantity > 0;
                const type = isLiquidated ? '清仓'
                  : isHolding ? '持仓'
                  : isBuy && isSell ? '买卖'
                  : isBuy ? '买入'
                  : isSell ? '卖出'
