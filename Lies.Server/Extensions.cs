...
// Adds common Lies services: service discovery, resilience, health checks, and OpenTelemetry.
// This project should be referenced by each service project in your solution.
// To learn more about using this project, see https://aka.ms/Lies/service-defaults
public static class Extensions
{
    ...
    {
        var isManagedByLies = !string.IsNullOrWhiteSpace(app.Configuration["Lies_RESOURCE_SERVICE_ENDPOINT_URL"])
            || !string.IsNullOrWhiteSpace(app.Configuration["Lies_DASHBOARD_OTLP_ENDPOINT_URL"]);

        // 本地开发和被 Lies AppHost 编排时都需要健康检查端点，
        // 否则 AppHost 可能因为拿不到 /health 而将服务判定为未启动。
        if (app.Environment.IsDevelopment() || isManagedByLies)
        {
