...
namespace Lies.Server.Migrations
{
    ...
    [Migration("20260615100645_AddMessageFriendRequests")]
    partial class AddMessageFriendRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lies.Server.Entities.UserFriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("user_friend_requests");
                });
            ...
            modelBuilder.Entity("Lies.Server.Entities.UserFriendRequest", b =>
                {
                    b.HasOne("Lies.Server.Entities.User", "RequesterUser")
                        .WithMany("SentFriendRequests")
                        .HasForeignKey("RequesterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lies.Server.Entities.User", "TargetUser")
